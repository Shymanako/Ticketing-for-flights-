                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <select name="direction_id">
                                                ...
                                                ?>
                                                        <option <?php if ($current_direction_id == $direction_id) {
                                                                    echo "selected";
                                                                } ?> value="<?php echo $direction_id; ?>"><?php echo $direction_id; ?></option>
                                                    <?php
                                                    }
                                                } else {
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date" value="<?php echo $departure_date; ?>" name="departure_date">
                                        </div>
                                        <div class="mb-3">
                                            <label>Departure Time:</label>
                                            <input type="time" value="<?php echo $departure_time; ?>"  name="departure_time">
                                        </div>
                                        <div class="mb-3">
                                            <label>Arrival Date:</label>
                                            <input type="date" value="<?php echo $arrival_date; ?>" name="arrival_date">
                                        </div>
                                        <div class="mb-3">
                                            <label>Arrival Time:</label>
                                            <input type="time" value="<?php echo $arrival_time; ?>" name="arrival_time">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="airline_id">
                                                ...
                                                ?>
                                                        <option <?php if ($current_airline_id == $airline_id) {
                                                                    echo "selected";
                                                                } ?> value="<?php echo $airline_id; ?>"><?php echo $airline_name; ?></option>
                                                    <?php
                                                    }
                                                } else {
                                                    // we do not have direction
