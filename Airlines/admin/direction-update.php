                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <select name="origin_airport_code">
                                                ...
                                                ?>
                                                        <option <?php if ($current_origin_airport_code == $airport_code) {
                                                                    echo "selected";
                                                                } ?> value="<?php echo $airport_code; ?>"><?php echo $airport_name; ?></option>
                                                    <?php
                                                    }
                                                } else {
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <select name="destination_airport_code">
                                                ...
                                                ?>
                                                        <option <?php if ($current_destination_airport_code == $airport_code) {
                                                                    echo "selected";
                                                                } ?> value="<?php echo $airport_code; ?>"><?php echo $airport_name; ?></option>
                                                    <?php
                                                    }
