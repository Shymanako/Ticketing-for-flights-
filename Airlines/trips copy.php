...
<body>
    ...
    <section class="trips">
        ...
        <div class="box-container">
            ...
            <?php
            $query = "SELECT flight.flight_id, flight.image, flight.description, schedule.schedule_id, schedule.direction_id, direction.origin_airport_code, airport.airport_name from flight left join schedule on flight.schedule_id = schedule.schedule_id left join direction on schedule.direction_id = direction.direction_id left join airport on direction.origin_airport_code = airport.airport_code";
            ...
            $query2 = "SELECT flight.flight_id, schedule.schedule_id, schedule.direction_id, direction.destination_airport_code, airport.airport_name from flight left join schedule on flight.schedule_id = schedule.schedule_id left join direction on schedule.direction_id = direction.direction_id left join airport on direction.destination_airport_code = airport.airport_code";
            ...
            if (mysqli_num_rows($query_run2) > 0) {
                while ($row2 = mysqli_fetch_assoc($query_run2)) {
                    ...
                    $destination_airport_name = $row2['airport_name'];
                    ...
                    ?>
                        ...
                        <div class="box">
                            ...
                            ?>
                            <td value="<?php echo $origin_airport_code;?>"><?php echo $origin_airport_code; ?></td> to
                            <td value="<?php echo $destination_airport_code;?>"><?php echo $destination_airport_name; ?></td>
